...
class UserModel(BaseModel):
    """Модель, описывающая пользователя
     ...
     Основная сущность платформы. Содержит email, Discord ID, пароль и роль.
    ...
    primary_discord_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True, unique=True)
    secondary_discord_id: Mapped[Optional[int]] = mapped_column(BigInteger, nullable=True, unique=True)
