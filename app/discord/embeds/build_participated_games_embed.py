# app/discord/embeds/build_participated_games_embed.py
from disnake import Embed, Color
from app.dto import PaginatedResponseDTO, GameResponseDTO

def build_participated_games_embed(result: PaginatedResponseDTO[GameResponseDTO], page: int) -> Embed:
    embed = Embed(title="🗺️ Игры в которых я участвую", color=Color.green())

    if not result.items:
        embed.description = "Вы пока не участвуете ни в одной игре."
    else:
